...
if termo:
    ...
    # Exibição dos resultados na COLUNA 1 (Shibata)
        ...
        with col1:
                    # ==================================================================
                    # INÍCIO DA CORREÇÃO 1 (Cabeçalho Shibata)
                    # ==================================================================
                    html_shibata_header = f"""
...
"""
                    st.markdown(html_shibata_header, unsafe_allow_html=True)
                    # ==================================================================
                    # FIM DA CORREÇÃO 1
                    # ==================================================================
                    ...
                    for p in produtos_shibata_ordenados:
                        ...
                        # ==================================================================
                        # INÍCIO DA CORREÇÃO 2 (Loop de Produto Shibata)
                        # ==================================================================
                        # Renderização final do produto
                        html_shibata_product = f"""
...
"""
                        st.markdown(html_shibata_product, unsafe_allow_html=True)
                        # ==================================================================
                        # FIM DA CORREÇÃO 2
                        # ==================================================================
    ...
    with col2:
        # ==================================================================
        # INÍCIO DA CORREÇÃO 3 (Cabeçalho Nagumo)
        # ==================================================================
        html_nagumo_header = f"""
<h5 style="display: flex; align-items: center; justify-content: center;">
...
"""
        st.markdown(html_nagumo_header, unsafe_allow_html=True)
        # ==================================================================
        # FIM DA CORREÇÃO 3
        # ==================================================================
        ...
        for p in produtos_nagumo_ordenados:
            ...
            # ==================================================================
            # INÍCIO DA CORREÇÃO 4 (Loop de Produto Nagumo)
            # ==================================================================
            html_nagumo_product = f"""
...
<hr class='product-separator' />
"""
            st.markdown(html_nagumo_product, unsafe_allow_html=True)
            # ==================================================================
            # FIM DA CORREÇÃO 4
            # ==================================================================
